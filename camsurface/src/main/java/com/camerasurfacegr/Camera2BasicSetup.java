...
public class Camera2BasicSetup extends Fragment {
    ...
    private static final String TAG = "Camera2BasicSetup";

    private static Camera2BasicSetup __instance;
     ...
     *
     * @return instance of Camera2BasicSetup
     */
    public static Camera2BasicSetup getInstance() {
        if (__instance == null) {
            __instance = new Camera2BasicSetup();
    ...
    /**
     * Callback from our {@link OnViewportSizeUpdatedListener Camera2BasicSetup.OnViewportSizeUpdatedListener}
